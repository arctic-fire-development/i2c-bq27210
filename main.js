// This is a sketch of how to read the BQ27210 via I2C on an Edison, using NES's custom power distribution board.

var readline = require('readline');
var m = require('mraa');
var i2c = new m.I2c(1);
i2c.address(0x55); // Address of the chip on the I2C bus

// Set the bus to the right speed -- by default it's running too fast.
...
function readBattery() {
  ...
  console.log("Result (Consolidated State Of Charge %): " + d);
...
function readInt16(highReg, lowReg) {
  // from page 26 of the docs for the BQ27210, this is the way to read 16 bit values.
